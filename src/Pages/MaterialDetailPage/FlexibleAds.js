...
export default function FlexibleAds({windowDimensions,setWindowDimensions}) {
 ...
 gsap.to('#img4',
 {
  ...
  return (
    ...
    <img id ="img0" src = {imagelist[0].src}  style = {{transition:'1s ease-in-out',opacity:'1'}}></img>
    <img  id ="img1"  src = {imagelist[1].src} style = {{transition:'1s ease-in-out'}}></img>
    <img  id ="img2"  src = {imagelist[2].src} style = {{transition:'1s ease-in-out'}}></img>
    <img  id ="img3"  src = {imagelist[4].src} style = {{transition:'1s ease-in-out'}}></img>
    <img  id ="img4"  src = {imagelist[5].src} style = {{transition:'1s ease-in-out'}}></img>
    <div style ={{color:'rgba(255,255,255,0.9)', lineHeight:'1.5',position:'absolute', top: '70%',left:'50%',transform:'translate(-50%,-50%)'}}>
        <div style = {{fontSize:'3.5vw'}}>Dẻo dai. bền bỉ. </div>
