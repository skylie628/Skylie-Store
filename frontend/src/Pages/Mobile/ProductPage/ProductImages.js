...
export default function ProductImages() {
  ...
  return (
    ...
    <div className={styles.productImage}>
        <img className = {styles.showingImg} src={showingImage} style={{width:'100%',objectFit:'cover',cursor:'pointer',transition:'1s ease-in-out'}}></img>
    </div>
    <div className={styles.thumbnail}>
     ...
     <div className = {styles.thumbnailImg}>
     <img src="https://firebasestorage.googleapis.com/v0/b/skylie-store.appspot.com/o/Products%2Fside%20product%2Fproduct3.png?alt=media&token=4742a268-8e07-496c-8e20-c77fe3b5409b&_gl=1*ghmrhi*_ga*MTg3ODkxNTgyNC4xNjgyNDg0MzQ3*_ga_CW55HF8NVT*MTY4NjYzNTY4Mi41LjEuMTY4NjYzNTc1My4wLjAuMA.." style={{width : '100%'}} onClick = {(img)=>{changeImage(img)}}></img>
    </div>   
     <div className = {styles.thumbnailImg}>
