...
export default function OrderSuccess() {
  ...
  return (
    <div className = {styles.card} >
        <Logo src={SuccessIcon} style={{width: '50px',height:'50px',margin:'0 auto'}}></Logo>
        
        <div style ={{fontWeight:'bold',fontSize:'20px',margin:'40px 0px 20px 0px'}}>Order Success.</div>
        ...
        <div className ={styles.control}>
            <div onClick={()=>navigate('../shopping')}>{'<'} Go home</div>
