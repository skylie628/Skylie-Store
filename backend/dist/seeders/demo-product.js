...
module.exports = {
  up: function up(queryInterface, Sequelize) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var id, optionId, productsList, colorList, optionsList;
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            */
            ...
            _context.next = 5;
            return queryInterface.bulkInsert('Products', productsList.map(function (x) {
              return {
                name: x.name,
                id: x.id,
                lasted: x.lasted,
          ...
          case 5:
            colorList = productsList.map(function (product) {
              return product.color.map(function (color) {
                return {
                  ColorId: color,
            ...
            optionsList = productsList.map(function (product) {
            ...
            _context.next = 9;
            return queryInterface.bulkInsert('Product_Color', colorList, {});
          case 9:
            _context.next = 11;
            return queryInterface.bulkInsert('ProductOptions', optionsList, {});
          case 11:
          case "end":
...
//# sourceMappingURL=demo-product.js.map