    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return queryInterface.createTable('ShippingAddresses', (_queryInterface$creat = {
              id: {
                allowNull: false,
                primaryKey: true,
            ...
            }, _defineProperty(_queryInterface$creat, "account_id", {
              type: Sequelize.STRING
            }), _defineProperty(_queryInterface$creat, "address", {
              type: Sequelize.STRING
