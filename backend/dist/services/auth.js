...
var hashPasword = function hashPasword(password) {
...
var registerService = function registerService(_ref) {
  ...
  return new Promise( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var id, _yield$db$Account$fin, _yield$db$Account$fin2, user, isCreated, token;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            id = (0, _uuid.v4)();
            _context.next = 3;
            return (0, _cart.addCartServices)(id);
          case 3:
            _context.next = 5;
            return _models["default"].Account.findOrCreate({
              where: {
                email: email
              },
              defaults: {
          ...
          case 5:
            _yield$db$Account$fin = _context.sent;
            _yield$db$Account$fin2 = _slicedToArray(_yield$db$Account$fin, 2);
            user = _yield$db$Account$fin2[0];
            isCreated = _yield$db$Account$fin2[1];
            if (!isCreated) {
              reject(new _ConflictError["default"]('Email đã được đăng ký trước đó'));
            }
            token = isCreated && _jsonwebtoken["default"].sign({
              id: user.id,
              email: user.email
...
var loginService = function loginService(_ref3) {
  ...
  return new Promise( /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var response, isCorrectPassword, token;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            isCorrectPassword = response && _bcryptjs["default"].compareSync(password, response.password);
            ...
            if (!token) {
              reject(new _unauthorizedError["default"]('Xác thực ngưới dùng không hợp lệ'));
            }
            resolve({
              err: null,
