...
exports.updateComment = exports.getComments = exports.deleteComment = exports.checkAllowComment = exports.addComment = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          _context.next = 5;
          return (0, _comment.addCommentServices)(req.body);
        case 5:
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          _context2.next = 5;
          return (0, _comment.getCommentsServices)(req.query);
        case 5:
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          _context3.next = 5;
          return (0, _comment.updateCommentServices)(req.body);
        case 5:
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          _context4.next = 6;
          return (0, _comment.deleteCommentServices)(req.query);
        case 6:
...
var checkAllowComment = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          _context5.next = 5;
          return (0, _comment.checkAllowServices)(req.query);
        case 5:
  ...
  return function checkAllowComment(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
exports.checkAllowComment = checkAllowComment;
